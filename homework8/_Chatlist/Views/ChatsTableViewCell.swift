...
class ChatsTableViewCell: UITableViewCell {
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            labelName.trailingAnchor.constraint(equalTo: wrapperCellView.trailingAnchor, constant: -50),
            ...
            labelTime.leadingAnchor.constraint(equalTo: wrapperCellView.trailingAnchor, constant: -42),
